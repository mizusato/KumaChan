...
var Keywords = [...] string {
    ...
    "@section",
    "@singleton", "@union", "@trait", "@signature",
    "@schema",
...
var SyntaxDefinition = [...] string {
    ...
    "decls? = decl decls",
      "decl = decl_section | decl_function | decl_type | decl_native_type",
        ...
        "decl_type = sin | sig | union | trait | schema | class | interface",
          "sin = @singleton name! | @singleton {! namelist! }!",
          "sig = @signature name! type_params =! type_function!",
          ...
          "schema = schema_head name! type_params bases {! field_list! }!",
            "schema_head = attributes @struct",
              "attributes? = attribute attributes",
                "attribute = _at name! type_params",
            "bases? = < typelist!",
    ...
    /* Group: Command */
    "command = cmd_group1 | cmd_group2 | cmd_group3 | cmd_group4",
      ...
      "cmd_group4 = cmd_async | cmd_pass | cmd_side_effect",
        "cmd_async = @async body",
        "cmd_pass = @do @nothing",
