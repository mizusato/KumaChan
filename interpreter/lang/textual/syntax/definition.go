...
var __SyntaxDefinition = [...] string {
    "root = shebang stmts",
      "shebang? = Shebang",
      "stmts? = stmt stmts",
        "stmt = title | import | do | alias | " +
            "decl_type | decl_const | decl_method | decl_func",
          "title = Title",
    ...
    "decl_type = docs meta @type name! type_params impl type_def ;!",
      ...
      "type_params? = [ type_param! more_type_params ]!",
        ...
        "type_param = variance name default_type",
          "variance? = @in | @out",
          "default_type? = @= type!",
      "func_type_params? = [ func_type_param more_func_type_params ]",
        "more_func_type_params? = , func_type_param more_func_type_params",
        "func_type_param = name bound",
          "bound? = hi_bound | lo_bound",
            "hi_bound = @< type!",
            "lo_bound = @> type!",
    "decl_method = docs meta scope @method receiver! .! name! :! type! body ;!",
      "receiver = name",
    "decl_func = docs meta scope @function name! :! sig! body ;!",
      "scope? = @export",
      "sig = func_type_params implicit repr_func",
